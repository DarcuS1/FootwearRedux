      ...
      <div className="px-10 py-24 mx-auto max-w-7xl">
        <div className="w-full mx-auto text-left md:text-center">
          <h1 className="mb-6 text-5xl font-extrabold leading-none max-w-5xl mx-auto tracking-normal text-gray-900 sm:text-6xl md:text-6xl lg:text-7xl md:tracking-tight">
            ...
            for
            <br className="lg:block hidden" /> all your footwear needs.
          </h1>
          <p className="px-0 mb-6 text-lg text-gray-600 md:text-xl lg:px-24">
            Say hello to the number one source for all your footwear needs.Go
            through a huge curated list of good quality pre-owned shoes.
          </p>
        </div>
      </div>
            ...
            <div className="order-1 w-full px-3 lg:w-1/2 lg:order-0">
              <div className="w-full lg:max-w-md">
                <h2 className="mb-4 text-3xl font-bold leading-tight tracking-tight sm:text-4xl font-heading">
                  Jam-packed with all the features you need to find you perfect
                  pair!
                </h2>
                <p className="mb-4 font-medium tracking-tight text-gray-400 xl:mb-6">
                  It's never been easier to find your own choice of style. Our
                  listings are filtered as follows:
                </p>
                <ul>
                  <li className="flex items-center py-2 space-x-4 xl:py-3">
                    ...
                    <span className="font-medium text-gray-500">
                      Pre-check from the picture to assure quality
                    </span>
                  </li>
                  <li className="flex items-center py-2 space-x-4 xl:py-3">
                    <svg
                    ...
                    <span className="font-medium text-gray-500">
                      Secure tracking and shipping availabilty
                    </span>
                  </li>
                  <li className="flex items-center py-2 space-x-4 xl:py-3">
                    <svg
                    ...
                    <span className="font-medium text-gray-500">
                      100% Protection and Security for your payment to sellers
                    </span>
                  </li>
                </ul>
              </div>
