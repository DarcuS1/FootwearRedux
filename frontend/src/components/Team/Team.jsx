  ...
  return (
    <section className="relative py-20 overflow-hidden bg-white">
      ...
      <div className="relative px-16 mx-auto max-w-7xl">
        ...
        <div className="grid w- justify-center grid-cols-2 gap-10">
          <div className="flex flex-col items-center justify-center col-span-1">
            <div className="relative p-5">
              <div className="absolute z-10 w-full h-full -mt-5 -ml-5 rounded-full rounded-tr-none bg-blue-50"></div>
              <img
                className="relative z-20 w-1/2 rounded-full"
                src="https://media.licdn.com/dms/image/D5603AQHj2pBQJb5-wg/profile-displayphoto-shrink_800_800/0/1692787982479?e=1710979200&v=beta&t=HW-RQgGg9ZVjBrnVKsE80Z_QigxP3NVwow_oT2Kzoyg"
                alt="Gelu-Samuel Josan"
              />
            </div>
            <div className="mt-3 space-y-2 text-center">
              <div className="space-y-1 text-lg font-medium leading-6">
                <h3>Gelu-Samuel Josan</h3>
          ...
          <div className="flex flex-col items-center justify-center col-span-1">
            <div className="relative p-5">
              ...
              <img
                className="relative z-20 w-1/2 rounded-full"
                src="https://media.licdn.com/dms/image/C4E03AQE5Uou_beqWxQ/profile-displayphoto-shrink_800_800/0/1650655378093?e=1710979200&v=beta&t=wdJgqUu2QDC7UJ-z0gKqap6PthEF-fcCzSF3srOYs6Q"
                alt="Catalin Cot"
              />
            </div>
            <div className="mt-3 space-y-2 text-center">
