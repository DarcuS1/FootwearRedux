/**
 * v0 by Vercel.
 * @see https://v0.dev/t/Q6cuGhhnFf1
 */
    ...
    >
      ...
      <main className="flex-grow bg-gray-100 dark:bg-gray-900">
        <section className="container mx-auto px-6 py-12">
          <h1 className="text-4xl font-bold text-center mb-10 text-blue-800 dark:text-blue-200">
            Welcome to FootwearRedux
          </h1>
          <p className="text-xl text-center mb-10 text-blue-600 dark:text-blue-400">
            Your one-stop shop for second-hand shoes.
          </p>
          <h2 className="text-2xl font-bold text-center mb-6 text-blue-800 dark:text-blue-200">
            Our Top Picks
          </h2>
